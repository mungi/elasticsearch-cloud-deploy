...
#TODO:  subnets         = ["${coalescelist(var.clients_subnet_ids, list(data.aws_subnet_ids.selected.ids[0]))}"]
  subnets = coalesce(var.clients_subnet_ids, data.aws_subnet_ids.selected.ids)
